...
if (isset($_POST['submit'])) {
    ...
    // ambil stok sekarang
    $q = mysqli_query($conn, "SELECT stock FROM produk WHERE id='$product_id'");
    ...
    // update stok
    mysqli_query($conn, "UPDATE produk SET stock='$stock_after' WHERE id='$product_id'");
...
<head>
  ...
  <title>Stock - Inventory Andre</title>
...
<?php endif; ?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Manajemen Stock - Inventory andre</h1>
      <nav>
        <ol class="breadcrumb">
