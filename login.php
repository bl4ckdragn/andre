...
// Kalau sudah login, langsung ke index (jangan biarkan akses login lagi)
...
if (isset($_POST['login'])) {
  ...
  $PASSWORD = $_POST['PASSWORD']; // ✅ huruf kecil, sesuai name di form
...
<head>
  ...
  <title>login - Inventory Andre</title>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="credits">
                Designed by <a href="https://www.instagram.com/andrx_yzzz?igsh=d3o5dWpydDd2OGw3">Andre</a>
              </div>
