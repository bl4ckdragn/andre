...
<head>
  ...
  <title>Kategori Produk - inventory andre</title>
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a index.php="index.html" class="logo d-flex align-items-center">
 ...
 <aside id="sidebar" class="sidebar">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a index.php="index.html">Dashboard</a></li>
